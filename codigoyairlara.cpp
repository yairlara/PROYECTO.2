...
while (continuar_programa=="si") {
        ...
        while (seguir_comprando == "si") {
         ...
         if (opcion_comida == 1) {
                ...
                if (edad_cliente >= 18) {  
                    ...
                    cout << "3. Coste�a - $" << PRECIO_COSTENA << endl;
                    ...
                    cout << "No puedes acceder al Bar, eres menor de 18 a�os." << endl;
                }
        ...
        cout << "Dime,�Cu�l es su saldo disponible? " << endl;
        cin >> saldo_cliente;
        ...
        if (saldo_cliente >= total_pedido) {
            ...
            // A�adir a las ganancias del caf�
 ...
 // Mostrar las ganancias totales
    ...
    cout << "Nos vemos ma�ana jefe, Adios." << endl;
